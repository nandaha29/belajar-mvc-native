...
class c_programKerja
{
    ...
    public function invoke()
    {
        ...
        // Memilih tindakan yang sesuai berdasarkan nilai 'action'
        switch ($action) {
            // Jika nilai 'action' adalah 'create', panggil method create()
            case 'create':
                $this->create();
                break;
            // Jika nilai 'action' adalah 'update', panggil method update()
            case 'update':
                $this->update();
                break;
            // Jika nilai 'action' adalah 'delete', panggil method delete()
            case 'delete':
                $this->delete();
                break;
            // Jika nilai 'action' tidak ada atau kosong, panggil method read()
            default:
                $this->read();
                break;
        }
